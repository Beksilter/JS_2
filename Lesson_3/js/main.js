...
class ProductItem extends Item {
    constructor(product, img = 'https://i.gifer.com/origin/fa/fa42f59abf3dbc7a04c1092eb08ec465_w200.gif') {
        super(
...
class CartItem extends Item{
    constructor(product, img = 'https://www.gifki.org/data/media/569/arbuz-animatsionnaya-kartinka-0004.gif') {
        super(
            product.product_name,
            product.price,
            product.id_product,
